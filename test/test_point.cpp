...
TEST_F(PointTestSuite, Minus) {
  GJK::Point point_difference = point1 - point2;
...
TEST_F(PointTestSuite, Add) {
  GJK::Point point_sum = point1 + point2;
...
TEST_F(PointTestSuite, Divide) {
  GJK::Point point_scaled = point1 / scalar;
...
TEST_F(PointTestSuite, Negative) {
  GJK::Point point_negative = -point1;
...
TEST_F(PointTestSuite, Normalize) {
  GJK::Point point_negative = point1.normalize();
